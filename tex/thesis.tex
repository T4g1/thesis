...
Our particular case is a requirements-based testing because we don't know how the product works but we do know what we expect of it. The goal of this work is to produce a product that can test any piece of sotfware or hardware without knowledge of how it works. We want a simple and robust tool to specify what is a correct behavior for any tested entity. By testing, we simply means that we want to be able to say wether or not the described behaviors where followed by the system or not. Without too much details now, such a tool is provided by \gls{fsm}.\\
