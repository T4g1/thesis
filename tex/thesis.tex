...
We will try to answer those type of question for any software or hardware using user defined scenario used to check that the software is working as expected. You can see the final implementation of those three use case in Section~\ref{sec:testcases}.
